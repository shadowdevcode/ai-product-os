/**
 * Shared error handling utilities for AI Product OS apps.
 *
 * Copy this file to apps/[project]/src/lib/error-handler.ts.
 *
 * Provides:
 *   - Sentry-integrated error capture
 *   - Structured API error responses
 *   - AI response parsing with safe fallback
